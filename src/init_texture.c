...
/*   Updated: 2018/05/12 17:21:07 by vguerand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!(pt_texture = mlx_xpm_file_to_image(var->mlx.mlx, "./t/pistol1.xpm",
		&var->t.w_pistol, &var->t.h_pistol)))
		ft_exit(3);
	var->t.t_pistol = mlx_get_data_addr(pt_texture, &(var->mlx.bpp),
		&(var->mlx.size_line), &(var->mlx.endian));
	if (!(pt_texture = mlx_xpm_file_to_image(var->mlx.mlx, "./t/floor.xpm",
